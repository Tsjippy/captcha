        ...
        case 'hcaptcha':
            ...
            if (str_contains($html, '[hcaptcha ')) {
                ...
                if (isset($_REQUEST['formbuilder'])) {
                    $url  = esc_url( network_admin_url('plugin-install.php?tab=plugin-information&plugin=hcaptcha-for-forms-and-more&TB_iframe=true&width=600&height=550' ) ) ;
            ...
            $node   = TSJIPPY\addRawHtml($html, $parent);
            break;
        case 'recaptcha':
            $html   = '';
            if (isset($_REQUEST['formbuilder'])) {
